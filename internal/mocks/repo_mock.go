...
// Source: github.com/passsquale/product-item-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/passsquale/product-item-api/internal/model"
)
...
func (m *MockEventRepo) Add(arg0 []model.ItemEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.ItemEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.ItemEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
